...
from SCA_App.models import Attendance, AttendanceReport, Courses, CustomUser, FeedBackStaffs, LeaveReportStaff, NotificationStaffs, OnlineClassRoom, SessionYearModel, Staffs, StudentResult, Students, Subjects
