"""Smart_Campus_Administration URL Configuration
...
from Smart_Campus_Administration import settings
from SCA_App.EditResultVIewClass import EditResultViewClass
from SCA_App import HodViews, StaffViews, StudentViews, views
...
urlpatterns = [
    ...
    path('manage_students_session',HodViews.manage_students_session,name="manage_students_session"),
    path('admin_get_students',HodViews.admin_get_students,name="admin_get_students"),
